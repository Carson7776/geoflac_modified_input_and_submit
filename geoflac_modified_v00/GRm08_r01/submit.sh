...
cp submit.sh /scratch2/humaorong/geoflac_modified_input_and_submit/geoflac_modified_v00/GRm08_r01
cp subduction.inp /scratch2/humaorong/geoflac_modified_input_and_submit/geoflac_modified_v00/GRm08_r01
